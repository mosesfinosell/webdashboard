import { Grid,Box,GridItem,Container,Text,Stack,Button,Flex, Center,Input,
    InputLeftElement,
    InputRightElement,
    InputGroup,
    FormControl,
...
>
 ...
 <Box  w='400px' h='80%' borderRadius='0px 11px 11px 11px' border='0.5px solid #D9D9D9'>
    ...
    <Center>
    <Stack mt='50px'>
      <Text fontSize='25px' fontWeight='bold' mb='40px'textAlign='center'>Find a Rider</Text>
      </Stack>
    </Center>
  <Center>
  {/* <Stack mt='40px'> */}
 ...
 <Box  h='100px' w='480px' borderRadius='0px 11px 0px 0px' border='0.5px solid #D9D9D9' display='flex' alignItems='center' px='30px'>


    <Text fontSize='16px' fontWeight='bold' color='black'>Orders in Delivery</Text>
