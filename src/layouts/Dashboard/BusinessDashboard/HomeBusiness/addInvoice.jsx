import { Grid,Box,GridItem,Container,Text,Stack,Center,Flex,Heading,
  ...
  <GridItem rowStart={2} colSpan={7}>
    ...
    <Box>
    <Stack mt='80px'>
    <Heading fontSize='16px' as='h6'>Contact Information</Heading>
    </Stack>
    <Stack mt='80px'>
            ...
            //    onChange={(e) => setPhoneNumber(e.target.value)}
                ...
                <Field name='text'>
                    {({ field, form }) => (
                         ...
                         <Select id='country' placeholder='Select a date' width='420px' h='70px' 
                           borderRadius='0px 11px 11px 11px'>
                ...
                //  onChange={(e) => setName(e.target.value)}
                 ...
                 <Field name='text' >
                  ...
                  <Field name='text'>
                    {({ field, form }) => (
                          <FormControl>
                          <FormLabel htmlFor='billing date'>Product</FormLabel>
                          <Select id='country' placeholder='Select product category' width='420px' h='70px' 
                            borderRadius='0px 11px 11px 11px'>
                            <option>United Arab Emirates</option>
                            <option>Nigeria</option>
                          </Select>
                 ...
                 <Field name='text' >
                    {({ field, form }) => (
                      <FormControl isInvalid={form.errors.name && form.touched.name}>
                        ...
                        value={email} 
                        // onChange={(e) => setEmail(e.target.value)}
                        placeholder='0%' width='200px' h='70px' borderRadius='0px 11px 11px 11px'/>
                      </InputGroup>
                        <FormErrorMessage>{form.errors.name}</FormErrorMessage>
                      </FormControl>
                    )}
                 ...
                 <Field name='text'>
                    {({ field, form }) => (
                        ...
                        <FormLabel htmlFor='billing date'>Billing Date</FormLabel>
                        <Select id='country' placeholder='Select a date' width='420px' h='70px' 
                          borderRadius='0px 11px 11px 11px'  mb='20px'>
                          <option>United Arab Emirates</option>
                          <option>Nigeria</option>
                        </Select>
                      </FormControl>
                  ...
                  <FormControl display='flex' alignItems='center' justifyContent='space-between' mb='20px'>
