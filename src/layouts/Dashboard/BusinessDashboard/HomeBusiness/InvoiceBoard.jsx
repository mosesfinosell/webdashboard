...
<GridItem colSpan={9} rowSpan={9} bg='white'>
    ...
    <Flex px='30px' direction='row' alignItems='center' justifyContent='space-between'>
        <Stack>
            <Text fontWeight='bold' fontSize='30px'>Invoice</Text>
        </Stack>
        <Flex direction='row'>
        <Formik 
           >
...
<Stack>
<Text color='black' fontSize='16px'>All Invoice</Text>
</Stack>
...
<Box px='20px' h='100px' w='60vw'  border='0.5px solid #D9D9D9' display='flex'  alignItems='center' justifyContent='space-between'>
     <Stack>
