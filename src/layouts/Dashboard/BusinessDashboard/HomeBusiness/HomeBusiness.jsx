import { Grid,Box,GridItem,Container,Text,Stack,Center,Link, Heading,Tabs, TabList, TabPanels, Tab, TabPanel,Flex} from "@chakra-ui/react";
...
>
 ...
 <Center>
  <TabList>
 <Tab>
 <Box as='button' borderRadius='md' bg='yellow.500' w='170px' color='white' px={4} h='35px' borderRadius='0px 11px 11px 11px'>
 Savings Balance
</Box>
 </Tab>
  </TabList>
<TabList>
  <Tab>
  <Box as='button' bg='white.500' w='210px' h='35px' color='gray' px={34}>
  Payments Balance
</Box>
  </Tab>
</TabList>
...
<Tabs/>
 ...
 <Stack pl='30'>
 <Stack pt='23'>
     <Text color='gray' fontSize='14px'>Virtual Account Details</Text>
 </Stack>
 

 <Box as='button' h='140px' w='350px' borderRadius='0px 11px 11px 11px' border='0.5px solid #D9D9D9'>
     
     <Flex display='flex' alignItems='center' justifyContent='space-evenly' pb='20px'>
     <Stack>
      <Text color='gray' fontSize='12px'>Account Number</Text>
     ...
     <Flex display='flex' alignItems='center' justifyContent='space-evenly'>
      <Stack>
      <Text color='gray' fontSize='12px'>Bank</Text>
      <Text fontSize='14px'>Polaris Bank</Text>
      </Stack>  
      <Stack>
      <Text color='gray' fontSize='12px'>Account Name</Text>
...
<Stack pt='23'>
     ...
     <Stack fontSize='34px' color='yellow.500' px='32px'>
         ...
         <Stack>
         <Link as={RLink} to='store-inventory' textAlign='left'>Store Inventory</Link> 
