...
export default function OrderDirectModal() {
           ...
           <BiShoppingBag/>
            ...
            > 
              ...
              <ModalContent>
                ...
                <ModalBody>
                  <Center>
                <Box  h='560px' w='400px'   border='0.5px solid #D9D9D9' mt='70px'  borderRadius='0px 11px 11px 11px'>
                  ...
                  <Text color='green' fontSize='20px'>Direct</Text>
                  </Stack>
                 </Box>
                 </Center>
                 <Flex direction='row' alignItems='center' mb={7} justifyContent='space-evenly'>
                <Button
                  mt={4}
                  bg='yellow.500'
                  width='150px' h='70px'
