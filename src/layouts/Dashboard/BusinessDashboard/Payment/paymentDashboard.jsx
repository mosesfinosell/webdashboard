import { Grid,Box,GridItem,Container,Text,Stack, Center, Tabs, TabList, TabPanels, Tab, TabPanel, Input,
    InputLeftElement,
    InputRightElement,
    InputGroup,
    FormControl,
...
>
 ...
 <Stack pb='30px'>
     <Text color='black' fontWeight='bold' fontSize='14px'>Add a transaction</Text>
 </Stack>
     ...
     <Formik>
              {() => (
                <Form>
                    ...
                    {({ field, form }) => (
                      ...
                      <FormControl isInvalid={form.errors.name && form.touched.name} mt='30px'>
            ...
            //    onChange={(e) => setPhoneNumber(e.target.value)}
                ...
                <Field name='text'>
                    {({ field, form }) => (
                         <FormControl>
                         <FormLabel htmlFor='billing date'>Type of Transaction</FormLabel>
...
<Tabs variant='unstyled'>
 ...
 <Box  h='100px' w='480px' borderRadius='0px 11px 0px 0px' border='0.5px solid #D9D9D9' display='flex' alignItems='center' justifyContent='center'>
  ...
  <TabList >
    ...
    <Tab fontSize='16px' fontWeight='bold'   color='black'>All</Tab>
    <Tab fontSize='16px' fontWeight='bold'   color='black'>Payments</Tab>
    <Tab fontSize='16px' fontWeight='bold' color='black'>Debit</Tab>
  </TabList>
   ...
   <TabPanels>
    ...
    <Box  h='100px' w='480px'  border='0.5px solid #D9D9D9' display='flex' alignItems='center' justifyContent='space-evenly'>
         ...
         <Stack color='yellow.500' bg='yellow.100' borderRadius='0px 8px 8px 8px' border='0.2px solid green.100'  p='12px' fontSize='22px' >
           <BiShoppingBag/>
           </Stack>
          <Stack pr='120px'>
          <Text color='#273B4A' w='200px'> Sneakers Adidas Core</Text>
