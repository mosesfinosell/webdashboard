  ...
  return (
    <>
      ...
      <RiskFree className="reverse">
        ...
        <ProductSectionContent>
          <PrimaryTitle>
            Enjoy risk-free transactions with Paysecure
          </PrimaryTitle>
          <YellowParagraph>
            Paysecure protects buyers and sellers by temporarily holding money
            in a trusted account and allows payment to be made after goods and
            services have been received in good condition.
          </YellowParagraph>
          <List>
            <li className="easily">Buyer and seller agree on terms</li>
            <li className="easily">The buyer makes payment to Paysecure</li>
            <li className="easily">Buyer approves purchase</li>
            <li className="easily">Paysecure makes payment to the seller</li>
          </List>
